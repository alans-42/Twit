...
var FileUploader = require('twit/lib/file_uploader');
var helpers = require('twit/lib/helpers');
var StreamingAPIConnection = require('twit/lib/streaming-api-connection');
var STATUS_CODES_TO_ABORT_ON = require('twit/lib/settings').STATUS_CODES_TO_ABORT_ON;
