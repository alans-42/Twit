...
var ExceptionHandler = require('winston/dist/winston/exception-handler');

var RejectionHandler = require('winston/dist/winston/rejection-handler');

var LegacyTransportStream = require('winston-transport/legacy');

var Profiler = require('winston/dist/winston/profiler');

var _require3 = require('winston/dist/winston/common'),
    warn = _require3.warn;

var config = require('winston/dist/winston/config');
/**
