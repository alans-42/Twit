...
var checkReply = require('twit/tests/rest').checkReply;
var checkResponse = require('twit/tests/rest').checkResponse;
var checkTweet = require('twit/tests/rest').checkTweet;
